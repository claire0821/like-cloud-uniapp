	...
	<view class="goods-list">
			...
			<navigator v-for="(item, index) in list" :key="index" class="item bg-white mt20" hover-class="none" open-type="navigate"
			 :url="'/pages/product/product?skuId=' + item.skuId + '&spuId=-1'">
				<view class="goods-img" style="width: 347rpx;height:347rpx;">
					<custom-image :lazy-load="true" width="347rpx" height="347rpx" radius="10rpx" lazy-load :src="item.img"></custom-image>
				</view>
				<view class="goods-info">
					...
					<view class="price mt10 row">
						...
						<price-format class="muted" :firstSize="24" :secondSize="24" :subscript-size="24" line-through :price="item.activity_price"></price-format>
					</view>
				</view>
			</navigator>
		</view>
		<view v-if="type === 'hot'" class="goods-hot">
			...
			:url="'/pages/product/product?skuId=' + item.skuId + '&spuId=-1'">
				<view class="goods-img" style="width: 180rpx;height:180rpx;">
					<custom-image :lazy-load="true" width="180rpx" height="180rpx" radius="6rpx" lazy-load :src="item.img"></custom-image>
				</view>
				<view class="goods-info ml20">
					<view class="goods-name line2 mb10">{{item.name}}</view>
					<text class="sale br60 xxs">已有{{item.saleCount}}人购买</text>
					<view class="row-between  mt10">
						<view class="price mt10 row">
							<price-format color="#FF2C3C"  class="mr10" :first-size="34" :second-size="26" :subscript-size="26" :price="item.price" :weight="500"></price-format>
							<price-format class="muted" :firstSize="24" :secondSize="24" :subscript-size="24" line-through :price="item.activityPrice"></price-format>
						</view>
			...
			<navigator v-for="(item, index) in list" :key="index" class="item bg-white mb20 row" hover-class="none" open-type="navigate"
			 :url="'/pages/product/product?skuId=' + item.skuId + '&spuId=-1'">
				<view class="goods-img">
					<custom-image :lazy-load="true" width="240rpx" height="240rpx" radius="6rpx" lazy-load :src="item.img"></custom-image>
				</view>
		...
		<view v-if="type === 'new'" class="goods-new">
			<navigator v-for="(item, index) in list" :key="index" class="item bg-white mt20 row" hover-class="none" open-type="navigate"
			 :url="'/pages/product/product?skuId=' + item.skuId + '&spuId=-1'">
				<view class="goods-img">
					<custom-image :lazy-load="true" width="240rpx" height="240rpx" radius="10rpx" lazy-load :src="item.img"></custom-image>
				</view>
				<view class="goods-info ml20 mr20 flex1">
					...
					<view class="row-between muted xxs ">
						<view class="line-through">
							<text>原价</text>
							<price-format :second-size="22" :first-size="22" :subscript-size="22" :price="item.activityPrice"></price-format>
						</view>
						<view>{{item.saleCount}}人购买</view>
					</view>
					<view class="row-between  mt10">
		...
		<view v-if="type === 'one'" class="goods-one mt20">
			...
			:url="'/pages/product/product?skuId=' + item.skuId + '&spuId=-1'">
				<view class="goods-img" style="width: 200rpx;height:200rpx;">
					<custom-image :lazy-load="true" width="200rpx" height="200rpx" radius="6rpx" lazy-load :src="item.img"></custom-image>
				</view>
				<view class="goods-info ml20">
					<view class="goods-name line2 mb10">{{item.name}}</view>
					<view class="row-between mt10">
